...
export default function CreditCardIconList() {
    ...
    useEffect(() => {
        axios.get('http://localhost:8080/spendwisepro_admin/credit_card_icons/all', { headers })
            .then(response => {
        ...
        <Card className="w-full shadow-lg mt-8">
            <CardBody>
                <Typography variant="h5" color="blue-gray" className="mb-4 flex items-center justify-between">
                    All Icons
                    <Link to="/add_credit_card_icon" onClick={storeScrollPosition}>
