        ...
        <Card className="w-full shadow-lg">
            <CardBody>
                ...
                {goals.length > 0 && (
                    <div>
                        <div>
                            {goals.filter(goal => goal.period === "weekly").length > 0 && (
                        ...
                        <div>
                            {goals.filter(goal => goal.period === "monthly").length > 0 && (
                                <Typography variant="h6" className="text-gray-900 mb-2">
                                    Monthly
                                </Typography>
                            )}
                ...
                {goals.length === 0 && (
                    <div>
                        ...
                        <div className="flex justify-center items-center">
                            <Link to="/add_goal" onClick={storeScrollPosition} className="w-full">
