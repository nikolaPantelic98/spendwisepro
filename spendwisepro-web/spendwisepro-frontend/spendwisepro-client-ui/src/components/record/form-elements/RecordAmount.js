...
export default function RecordAmount({ initialValue = "", formType, id }) {
    ...
    useEffect(() => {
        dispatch(setRecordAmount(initialValue));
    }, [initialValue]);

    const handleAmountClick = () => {
        navigate('/records/amount', { state: { amount: amount, from: navigateTo, selectedTab: selectedTab } });
    };
