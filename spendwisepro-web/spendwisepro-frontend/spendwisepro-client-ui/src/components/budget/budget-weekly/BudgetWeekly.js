                    ...
                    <div>
                        <div>
                            <ResponsiveContainer width="100%" height={210}>
                                <AreaChart className="right-4" data={dataSpent}
                                    ...
                                    <Tooltip />
                                    <ReferenceLine y={budgetAmount} label="Budget" stroke="red" strokeDasharray="3 3" isFront={true} alwaysShow={true} />
                                    <Area type="monotone" dataKey="amount" stroke="#82ca9d" fillOpacity={1} fill="url(#chartGreen)" />
                                    <Area type="monotone" dataKey="prediction" stroke="blue" fillOpacity={1} fill="transparent" />
                                </AreaChart>
                            </ResponsiveContainer>
                        </div>
                        ...
                        <div className="container mx-auto mt-6">
                            <p className="text-xs flex items-center justify-center gap-4">
                                ...
                                <span className="flex items-center">
                                    <span className="w-3 h-3 inline-block mr-1 bg-teal-300"></span>
                                    <span className="text-xxs">Spent</span>
                                 </span>
                                <span className="flex items-center">
                                    <span className="w-3 h-3 inline-block mr-1 bg-blue-700"></span>
