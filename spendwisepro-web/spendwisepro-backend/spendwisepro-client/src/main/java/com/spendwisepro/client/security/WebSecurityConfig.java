...
/**
 * The WebSecurityConfig class is responsible for configuring the security settings for the web application.
 * It defines the security filter chain, which includes the JWT authentication filter and the authentication provider.
 */
@Configuration
